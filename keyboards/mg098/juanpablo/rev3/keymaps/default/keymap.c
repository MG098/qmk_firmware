...
/* LAYER = FUNCTION
  ...
  */
  ...
  [_FN] = LAYOUT_split_69(
     ...
     _______, _______, _______, _______, _______, RM_TOGG,       _______, _______, _______, _______, _______, _______, _______, _______, NEXT,
     _______, _______, RM_SATU, _______, _______, _______,                RM_HUEU, _______, _______, _______, _______, _______, _______, PREV,
     _______, _______, _______, _______, _______, _______,                _______, RM_NEXT, _______, _______, _______, _______, RM_VALU, _______,
